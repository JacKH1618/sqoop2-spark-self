...
public class SqoopOutputFormatLoadExecutorSpark {

  public static final Logger LOG =
    Logger.getLogger(SqoopOutputFormatLoadExecutorSpark.class);
  ...
  SqoopOutputFormatLoadExecutorSpark(JobContext jobctx, String loaderName, IntermediateDataFormat<?> toDataFormat, Matcher matcher) {
    context = jobctx;
